...
public:
	// Constructors:
	inline BigInt();
	inline BigInt(const BigInt&);
	inline BigInt(const long long&);
	inline BigInt(const std::string&);

	// Assignment operators:
	inline BigInt& operator=(const BigInt&);
	inline BigInt& operator=(const long long&);
	inline BigInt& operator=(const std::string&);

	// Unary arithmetic operators:
	inline BigInt operator+() const;   // unary +
	inline BigInt operator-() const;   // unary -

									   // Binary arithmetic operators:
	inline BigInt operator+(const BigInt&) const;
	inline BigInt operator-(const BigInt&) const;
	inline BigInt operator*(const BigInt&) const;
	inline BigInt operator/(const BigInt&) const;
	inline BigInt operator%(const BigInt&) const;
	inline BigInt operator+(const long long&) const;
	inline BigInt operator-(const long long&) const;
	inline BigInt operator*(const long long&) const;
	inline BigInt operator/(const long long&) const;
	inline BigInt operator%(const long long&) const;
	inline BigInt operator+(const std::string&) const;
	inline BigInt operator-(const std::string&) const;
	inline BigInt operator*(const std::string&) const;
	inline BigInt operator/(const std::string&) const;
	inline BigInt operator%(const std::string&) const;
	...
	inline BigInt& operator++();       // pre-increment
	inline BigInt& operator--();       // pre-decrement
	inline BigInt operator++(int);     // post-increment
	inline BigInt operator--(int);     // post-decrement
